...
(function() {
  var Document, Element, EventEmitter, Selector, SelectorParser, XmlParser, _,
    __slice = [].slice,
  ...
  Document = (function() {
    ...
    function Document(elt) {
      this.documentElement = typeof elt === 'string' ? (elt = this.createElement(XmlParser.parse(elt)), elt.setOwnerDocument(this), elt) : elt instanceof Element ? elt.setOwnerDocument(this) : (elt = this.createElement(elt), elt.setOwnerDocument(this), elt);
      this._data = {};
    }
  ...
  Selector = (function() {
    ...
    function Selector(stmt) {
      this.select = SelectorParser.parse(stmt).select;
