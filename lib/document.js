...
(function() {
  var Document, Element, Entities, EventEmitter, ParseStack, XmlParser, entities, htmlParser, loglet, parse1, parse2, _,
    __slice = [].slice,
  ...
  ParseStack = (function() {
    ...
    ParseStack.prototype.rootElement = function() {
      var children;
      children = _.filter(this.root.children, function(elt) {
    ...
    ParseStack.prototype.push = function(name, attrs) {
      return this._pushElement({
        element: name,
        attributes: this.normalizeAttrs(attrs),
        children: []
      });
    };
    ...
    ParseStack.prototype._pushElement = function(elt) {
      if (this.root === null) {
        ...
        this.current().children.push(elt);
        return this.stack.push(elt);
      }
    };
    ...
    ParseStack.prototype.pushText = function(txt) {
      if (this.level() > 0) {
        return this.current().children.push(this.decode(txt));
      }
    };
