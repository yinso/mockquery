...
(function() {
  var Document, Element, EventEmitter, XmlParser, entities, htmlParser, loglet, parse2, _,
    __slice = [].slice,
  ...
  Document = (function() {
    ...
    Document.createElement = function(_arg) {
      var attributes, children, element;
    ...
    function Document(elt) {
      this.documentElement = elt instanceof Element ? (elt.setOwnerDocument(this), elt) : (elt = this.createElement(elt), elt.setOwnerDocument(this), elt);
      this._data = {};
    }
