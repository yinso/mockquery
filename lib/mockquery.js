...
(function() {
  var Document, Element, EventEmitter, MockQuery, Node, Parser, Selector, Serializer, XmlParser, fromJSON, fs, get, getJSON, http, https, kvs, load, loadHTML, loglet, path, postJSON, qs, readFile, readFileSync, statusCodeToError, url, _,
    __slice = [].slice;
