...
(function() {
  var Document, Element, EventEmitter, MockQuery, Node, Parser, Selector, Serializer, XmlParser, entities, fromJSON, fs, get, getJSON, http, https, jsonElement, kvs, load, loadHTML, loadJSON, loglet, path, postJSON, qs, readFile, readFileSync, statusCodeToError, url, _,
    __slice = [].slice;
