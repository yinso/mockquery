...
(function() {
  var Document, Element, EventEmitter, MockQuery, Parser, Selector, XmlParser, fs, get, getJSON, http, https, kvs, load, path, postJSON, qs, readFile, readFileSync, statusCodeToError, url, _,
    __slice = [].slice;
