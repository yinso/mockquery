...
(function() {
  var Document, Element, EventEmitter, MockQuery, Selector, XmlParser, fs, getJSON, http, https, kvs, load, path, postJSON, qs, readFile, readFileSync, statusCodeToError, url, _,
    __slice = [].slice;
