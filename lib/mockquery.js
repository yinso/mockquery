...
(function() {
  var Document, Element, EventEmitter, MockQuery, Parser, Selector, Serializer, XmlParser, fs, get, getJSON, http, https, kvs, load, loadHTML, loglet, path, postJSON, qs, readFile, readFileSync, statusCodeToError, url, _,
    __slice = [].slice;
