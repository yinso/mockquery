...
(function() {
  var Document, Element, EventEmitter, ParseStack, entities, htmlParser, loglet, parse1, parseDocument, parseElement, _;
  ...
  ParseStack = (function() {
    ...
    ParseStack.prototype.push = function(name, attrs) {
      return this._pushElement(new Element(name, this.normalizeAttrs(attrs)));
    };
