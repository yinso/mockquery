...
(function() {
  ...
  Selector = (function() {
    ...
    Selector.prototype.compileOne = function(exp) {
      ...
      return function(element) {
        return eltExp(element) && idExp(element) && classExp(element) && attrExp(element) && pseudoExp(element);
      };
    };
    ...
    Selector.prototype.compileOnePseudo = function(_arg) {
      ...
      if (pseudo === 'not') {
        ...
        return function(elt) {
          var res;
          res = innerExp(elt);
          console.log('pseudoInner', pseudo, args, res, !res);
          return !res;
        };
      } else {
        throw {
